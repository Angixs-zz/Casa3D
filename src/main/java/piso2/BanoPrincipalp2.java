...
public class BanoPrincipalp2 {
        ...
        public static void dibujar() {
                 ...
                 * 1. Área de Tina y Retrete: Rectángulo D1(0.1, 14.0) a T1(0.1, 15.4) y F1(2.5,
                 * 14.0)
        ...
        private static void dibujarTina(float xGeo, float zGeo, float rotacionY) {
                ...
                Cubo.dibujar(0f, 0.60f, -escalar(0.60f), escalar(0.15f), 0.15f, escalar(0.10f), 0.7f, 0.7f, 0.7f); // Base
                                                                                                                   // grifo
                Cubo.dibujar(0f, 0.65f, -escalar(0.50f), escalar(0.05f), 0.05f, escalar(0.15f), 0.7f, 0.7f, 0.7f); // Tubo
                                                                                                                   // grifo
